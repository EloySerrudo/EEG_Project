...
enum reg {
    ...
    CH7SET = CHnSET + 7,
    CH8SET = CHnSET + 8,
    RLD_SENSP = 0x0d,       // ADS1299: BIAS_SENSP
    RLD_SENSN = 0x0e,       // ADS1299: BIAS_SENSN
    LOFF_SENSP = 0x0f,
    LOFF_SENSN = 0x10,
    LOFF_FLIP = 0x11,
    ...
    // other
            GPIO = 0x14,
    PACE = 0x15,            // ADS1299: MISC1
    RESP = 0x16,            // ADS1299: MISC2
    CONFIG4 = 0x17,
    WCT1 = 0x18,            // ADS1299: NOT
    WCT2 = 0x19             // ADS1299: NOT
};
