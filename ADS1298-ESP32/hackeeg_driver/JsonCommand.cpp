...
void JsonCommand::readSerial() {
    ...
    while (Serial.available() > 0) {
        ...
        if (inChar == term) {     // Check for the terminator (default '\r') meaning end of command
            ...
            JsonVariant command_name_variant = command_object[COMMAND_KEY]; //Actualizaciíón ArduinoJson 6.20
...
#endif
            JsonVariant parameters_variant = json_command[PARAMETERS_KEY]; //Actualizaciíón ArduinoJson 6.20
